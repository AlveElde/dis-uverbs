...
static const struct verbs_match_ent hca_table[] = {
	VERBS_DRIVER_ID(RDMA_DRIVER_DIS),
...
static struct verbs_context *dis_alloc_context(struct ibv_device *vdev, int cmd_fd, void *private_data)
{
	return NULL;
}

static void dis_free_context(struct ibv_context *ibvctx)
{
}
...
static void dis_uninit_device(struct verbs_device *verbs_device)
{
}
